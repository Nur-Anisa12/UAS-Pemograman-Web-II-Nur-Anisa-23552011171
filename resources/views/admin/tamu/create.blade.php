...
@section('content')
    ...
    @php
        // Base classes untuk elemen input standar
        $inputBase =
        ...
        // Kontainer grup input untuk bagian Nomor HP
        $groupNormal =
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h5 class="font-bold text-lg text-gray-800 mb-0 leading-tight">Tambah Data Tamu</h5>
                <p class="text-sm text-gray-400 mb-0">Isi identitas lengkap tamu hotel baru</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-6 sm:p-8">
                <form action="{{ route(auth()->user()->role . '.tamu.store') }}" method="POST" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="identity_number"
                            ...
                            value="{{ old('identity_number') }}" placeholder="16 digit nomor KTP atau nomor paspor"
                            maxlength="20">
                        ...
                        @else
                            <p class="mt-1.5 text-xs text-gray-400">
                                Nomor ini harus unik — satu tamu satu nomor identitas
                            </p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="3"
                            ...
                            placeholder="Alamat lengkap tamu (opsional)">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <p class="mt-1.5 text-xs text-red-500 flex items-center gap-1">
                                <i class="bi bi-exclamation-circle-fill"></i> {{ $message }}
                            </p>

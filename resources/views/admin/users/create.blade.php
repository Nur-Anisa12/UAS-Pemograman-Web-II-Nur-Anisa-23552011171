...
@section('content')
    ...
    <div class="max-w-2xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h5 class="font-bold text-xl text-gray-800 mb-0 leading-tight">Buat Akun Baru</h5>
                <p class="text-sm text-gray-400 mb-0">Buat akun untuk Admin atau Petugas</p>
            </div>
        </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="email" name="email"
                                ...
                                value="{{ old('email') }}" placeholder="contoh: petugas@hotel.com">
                            @error('email')
                                <p class="mt-1.5 text-xs font-semibold text-red-600 flex items-center gap-1">
                                    <i class="bi bi-exclamation-circle"></i> {{ $message }}
                                </p>
                        ...
                        {{-- Info box --}}
                        <div
                            class="flex items-start gap-2.5 rounded-xl bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs font-medium px-4 py-3">
                            <i class="bi bi-info-circle mt-0.5"></i>
                            <p class="leading-relaxed">
                                Setelah akun dibuat, berikan <strong>email</strong> dan
                                <strong>password</strong> ini ke yang bersangkutan untuk login.
                            </p>
                        </div>
                    </div>
